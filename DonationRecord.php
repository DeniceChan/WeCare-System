...
<head>
    ...
    <title>WeCare: Donation Record</title>
...
<body>
    ...
    try {
        ...
        $stmt = $conn->prepare("SELECT * FROM give_donation");
        $stmt->execute();
...
<div class="container py-5">
    <div class="row justify-content-start">
        <div class="col-12">
            <h1 class="text-left" style="color: black; margin-left: 220px;">Donation Record</h1>
        </div>
    </div>
    <br>
        ...
        <div class="card rounded shadow border-0">
          <div class="card-body p-5 rounded" style="background-color: #fff; width: 910px;">
                        <!-- <div class="table-responsive"> -->
                            ...
                            <table id="donationList" class="rwd-table" style="width: 840px;">
                                <thead>
                                    <tr>
                                        <th class="booking-id-column" class="l">Transaction ID</th>
                                        <th>Donator Name</th>
                                        <th>Matric No</th>
                                        <th>Request ID</th>
                                        <th>Total</th>
                                ...
                                <tbody>
                                    ...
                                    foreach ($result as $row) {
                                        ...
                                        echo "<td>";
                                        echo "<button data-href='DonationRecordDetails.php?Transaction_ID={$row['Transaction_ID']}' class='custom-button-details' role='button'>Details</button>";
                                        echo "</td>";
                                        echo "</tr>";
                                    }
                                    ?>
...
<script>
    $(document).ready(function () {
        $(".custom-button-details").click(function () {
...
<script>
$(document).ready(function () {
    var table = $('#donationList').DataTable({
        lengthMenu: [
            [5, 10, 15, 25, 50],
            [5, 10, 22, 30, 'All'],
        ],
