...
<html lang="en">
    <head>
        ...
        <title>WeCare System: PERTAMA</title>
        <!-- Favicon-->
...
body {
    ...
    border-radius: 5px;
    cursor: pointer;
    box-shadow: 5px 5px 10px rgba(0, 0, 0, 0.3); /* Increased values for a more noticeable shadow */
}
    ...
    <div class="navbar">
      ...
      <nav>
        ...
        <div class="container">
            ...
            <div class="masthead-subheading" style="font-size: 60px;">Welcome Back!</div>
            <?php
                echo "<div class='masthead-heading text-uppercase'>$name</div>";
            ?>
...
<section class="page-section" id="services">
    <div class="container">
        <div class="text-center">
            <h2 class="section-heading text-uppercase">PERTAMA</h2>
            <h3 class="section-subheading text-muted">"Your Welfare Our Priority"</h3>
        </div>
        <div class="row text-center">
            <div class="col-md-4">
                <a href="DonateeRequestList.php" class="donateelist">
                    <span class="fa-stack fa-4x">
                        <i class="fas fa-circle fa-stack-2x text-primary"></i>
                        <i class="fas fa-hand-holding-dollar fa-stack-1x fa-inverse"></i>
                    </span>
                    <h4 class="my-3">Donation</h4>
                    <p class="text-muted">Click to view the list of donation requests.</p>
                </a>
            </div>
            <div class="col-md-4">
                <a href="CounsellingRequestList.php" class="donateelist">
                    <span class="fa-stack fa-4x">
                        <i class="fas fa-circle fa-stack-2x text-primary"></i>
                        <i class="fa-regular fa-face-smile fa-stack-1x fa-inverse"></i>
                    </span>
                    <h4 class="my-3">Counselling</h4>
                    <p class="text-muted">Click to view the list of counselling requests.</p>
                </a>
            </div>
            <div class="col-md-4">
                <a href="DonationRecord.php" class="donateelist">
                    <span class="fa-stack fa-4x">
                        <i class="fas fa-circle fa-stack-2x text-primary"></i>
                        <i class="fa-regular fa-rectangle-list fa-stack-1x fa-inverse"></i>
                    </span>
                    <h4 class="my-3">Donation Records</h4>
                    <p class="text-muted">Click to view the list of donation records.</p>
                </a>
            </div>
        </div>
    </div>
