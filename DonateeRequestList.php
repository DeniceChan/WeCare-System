...
<body>
    ...
    try {
        ...
        $stmt = $conn->prepare("SELECT * FROM request_donation_form");
        $stmt->execute();
                            ...
                            <table id="requestList" class="rwd-table" style="width: 840px;">
                                ...
                                <tbody>
                                    ...
                                    foreach ($result as $row) {
                                        ...
                                        echo "<td>";
                                        echo "<button type='button' onclick=\"window.location.href='DonateeDetails.php?request_id={$row['Request_ID']}'\" class='custom-button-details'>Details</button>";
                                        echo "</td>";
                                        echo "</tr>";
                                    }
                                    ?>
